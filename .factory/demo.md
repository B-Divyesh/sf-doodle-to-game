...
Open `/demo` or `/?demo=1` for the one-click sample. It starts **Maya and
Theo’s doodle dodge** with two original built-in drawings and the playable game
already open.
...
The two stores never share a record.
